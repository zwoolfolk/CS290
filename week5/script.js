/* Zachary Woolfolk */
/* CS290 */
/* Automobiles / Higher-Order Functions Assignment */
/* 4/30/2017 */
...
/*Bubble sort - source http://www.stoimen.com/blog/2010/07/09/friday-algorithms-javascript-bubble-sort/*/
...
function sortArr( comparator, array ){
    ...
    do{
    	...
    	for(var i = 0; i < array.length - 1; i++){
    		if(comparator(sorted[i], sorted[i+1])){
    			var temp = sorted[i];
    			sorted[i] = sorted[i+1];
    			sorted[i+1] = temp;
    			exchanged = true;
...
function typeComparator(auto1, auto2){
    ...
    var a = types[auto1.type];
    var b = types[auto2.type];
